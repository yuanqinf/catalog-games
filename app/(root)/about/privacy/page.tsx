    ...
    >
      ...
      <section className="rounded-lg bg-purple-900/20 p-6">
        ...
        <ul className="space-y-2 text-gray-300">
          ...
          <li>✓ Your game ratings and dislikes are anonymous and aggregated</li>
          <li>✓ We use Clerk for login and Supabase for database storage</li>
          <li>✓ Your search history stays in your browser, not our servers</li>
        ...
        <div className="space-y-4">
          <div>
            ...
            <p className="text-gray-300">
              Your email and username (handled by Clerk authentication). We also
              get your profile pic if you add one.
            </p>
          </div>
      ...
      <section className="space-y-4">
        ...
        <ul className="list-inside list-disc space-y-2 text-gray-300">
          ...
          <li>
            Stop spam and abuse - we have rate limits (100 clicks per minute for
            dislikes/reactions, 20 per minute for submissions)
          </li>
          <li>
      ...
      <section className="space-y-4">
        ...
        <div className="space-y-3">
          <div>
            <p className="text-gray-300">
              ...
              database. It&apos;s a PostgreSQL database with row-level security,
        ...
        <div className="mt-4 rounded-lg bg-gray-800 p-4">
          <p className="text-sm text-gray-300">
            ...
            rules, and rate limiting. But honestly? No system is 100% secure. We
            do our best, but can&apos;t guarantee perfection.
          </p>
        </div>
      </section>
      ...
      <section className="space-y-4">
        ...
        <ul className="list-inside list-disc space-y-2 text-gray-300">
          ...
          <li>
            <strong>Discord</strong> - Only gets your feedback if you submit it
      ...
      <section className="space-y-4">
        ...
        <ul className="list-inside list-disc space-y-2 text-gray-300">
          ...
          <li>
            <strong>After account deletion:</strong> 30 days to clean everything
            up
          </li>
        </ul>
      </section>
      ...
      <section className="space-y-4">
        ...
        <div className="space-y-4">
          ...
          <div>
            <h3 className="mb-2 text-lg font-medium text-purple-400">Kids:</h3>
            <p className="text-gray-300">
      ...
      <section className="space-y-4">
        ...
        <p className="text-gray-300">
          ...
          Updated&quot; date at the top. For big changes, we might post a notice
          on the homepage or send an email.
        </p>
      </section>
