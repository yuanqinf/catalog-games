        ...
        <div className="space-y-4">
          <div className="rounded-lg bg-gray-800/50 p-6">
            ...
            <div className="space-y-3 text-gray-300">
              ...
              <p>
                So I built Dissgame - an unofficial, fun platform where players
                can finally give the games they hate the bad reviews they
                actually deserve. No corporate BS, no soft scores. Just honest
                reactions from real players.
              </p>
          ...
          <div className="rounded-lg bg-gray-800/50 p-6">
            ...
            <p className="text-gray-300">
              ...
              (me!). It&apos;s a passion project, not backed by any corporation
              or game publisher. That&apos;s why we can be brutally honest.
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="space-y-6">
        ...
        <div className="space-y-4">
          ...
          <div className="rounded-lg bg-gray-800/50 p-6">
            ...
            <div className="space-y-3 text-gray-300">
              <p>Dead Games is a special section showcasing games that are:</p>
              <ul className="list-inside list-disc space-y-1 pl-4">
        ...
        <div className="space-y-4">
          ...
          <div className="rounded-lg bg-gray-800/50 p-6">
            ...
            <p className="text-gray-300">
              ...
              game&quot;), but nobody can see that YOU specifically clicked that
              button.
            </p>
          </div>
        </div>
        ...
        <div className="space-y-4">
          <div className="rounded-lg bg-gray-800/50 p-6">
            ...
            <div className="space-y-3 text-gray-300">
              ...
              <ul className="list-inside list-disc space-y-1 pl-4">
                <li>
                  <strong>IGDB (Internet Game Database):</strong> Game metadata,
                  images, descriptions
                </li>
                <li>
          ...
          <div className="rounded-lg bg-gray-800/50 p-6">
            ...
            <p className="text-gray-300">
              First, try refreshing the page or clearing your browser cache. If
              it&apos;s still broken, it might be a server issue (we&apos;re an
              indie project, stuff happens). Use the feedback system or check
              back later. We usually fix things pretty quickly.
            </p>
          </div>
          ...
          <div className="rounded-lg bg-gray-800/50 p-6">
            ...
            <p className="text-gray-300">
              Appreciate the interest! Right now, the best way to contribute is
              by using the site and providing feedback. If you&apos;re a
        ...
        <div className="space-y-4">
          <div className="rounded-lg bg-gray-800/50 p-6">
            ...
            <p className="text-gray-300">
              ...
              to manipulate votes, or spam the site, we&apos;ll ban you. Simple
              as that. Check our{' '}
              <Link
                href="/about/terms"
                className="text-purple-400 underline hover:text-purple-300"
          ...
          <div className="rounded-lg bg-gray-800/50 p-6">
            ...
            <p className="text-gray-300">
              ...
              suggest features, or ask questions. Your feedback goes directly to
              us via Discord.
            </p>
          </div>
        </div>
