...
import { X, ThumbsDown, MessageCircle } from 'lucide-react';
              ...
              {isHovered && (
                ...
                >
                  ...
                  <Button
                    ...
                    className="h-3.5 w-3.5 fill-current text-white transition-all duration-200 hover:scale-110 hover:bg-purple-600"
                  >
